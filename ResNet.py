...
def ResNet101(img_channels=3, num_classes=1000):
    return ResNet(block, layers=[3, 4, 23, 3], img_channels=img_channels, num_classes=num_classes)


def ResNet152(img_channels=3, num_classes=1000):
    return ResNet(block, layers=[3, 8, 36, 3], img_channels=img_channels, num_classes=num_classes)
